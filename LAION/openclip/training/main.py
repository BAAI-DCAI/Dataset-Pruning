...
from training.distributed import is_master, init_distributed_device, broadcast_object, create_deepspeed_config
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # Saving checkpoints.
        # is_master(args) can not be here while using deepspeed, otherwise ckpt can not be saved
